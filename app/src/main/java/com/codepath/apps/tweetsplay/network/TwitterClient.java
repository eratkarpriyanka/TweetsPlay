...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String HOME_TIMELINE_API = "statuses/home_timeline.json"; // Change this, base API URL
	public static final String REST_CONSUMER_KEY = "66xB1zdzDSMe1kSbdxMd4f2hf";       // Change this
	public static final String REST_CONSUMER_SECRET = "8jKZV6NGBNSn5boZMTDjk3aBdLrG3FqcOHgmg1BogDAVGIfUD2"; // Change this
	public static final String REST_CALLBACK_URL = "oauth://tweetsplay"; // Change this (here and in manifest)
